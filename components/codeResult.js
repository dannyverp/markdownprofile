    ...
    render() {
        return (
            ...
            <code className="whitespace-pre-wrap" dangerouslySetInnerHTML={{__html: this.props.template}}/>
                    ...
                    <div className="mt-6 lg:mt-0 lg:ml-12 bg-white shadow-md rounded px-8 pt-6 pb-8">
                        <h1 className="text-3xl border-b-2  border-orange-200 mb-6">Result</h1>
                        <ReactMarkdown source={this.props.template} className="markdownResult" />
                    </div>
                </main>
            </section>
        );
