...
const markdownHtml = Prism.highlight(code, Prism.languages.markdown, 'markdown');
        ...
        <div className="version">
            <div className="demo version-section"><a href="https://github.com/dannyverp/markdownprofile/"
                ...
                <svg width="80" height="80" viewBox="0 0 250 250"
                     style={{fill: '#ed8936', color: '#fff', position: 'absolute', top: 0, border: 0, right: 0,}}
                     aria-hidden="true">
        ...
        <header className="p-20 header">
            ...
            <section className="block xl:flex flex-row justify-center items-center">
                ...
                <div className="flex flex-col flex-1">
                    ...
                    <p className="mt-20 text-xl text-white">Github allows you to host your own Markdown page as an
                        ...
                        like badges for social media profiles, latest blog posts and other interesting features. These
                        templates will really spice up your profile <span>🔥</span></p>
                    <button
                        className="block mt-20 bg-orange-500 hover:bg-orange-400 text-white font-bold py-2 px-4 border-b-4 border-orange-700 hover:border-orange-500 rounded">Get
                        started
                    </button>
                </div>
            </section>
        ...
        <main className="py-16 px-20">
            <section>
                <header className="pb-2 border-0 border-b-2 border-orange-300">
                    <h2 className="text-3xl text-bold">Step 1 - <span className="text-xl">Pick the template you want to use.</span>
                    </h2>
                </header>
            ...
            <section>
                ...
                <main>
                    <pre className="language-css"><code dangerouslySetInnerHTML={{__html: markdownHtml}} /></pre>
                </main>
            </section>
        </main>
        <footer className="bg-gray-300 w-full px-20 py-8">
            <div className="md:flex items-center justify-between py-8">
                <p className="pt-4 md:pt-0 text-blue-500">All rights reserved</p>
                <p className="py-4 md:py-0 text-blue-500">Built with
                ...
                <div className="pb-4 md:pb-0 flex items-center">
                    ...
                    <a href="#">
                        <svg fill="none" className="h-6 w-6 text-blue-600 mr-6" viewBox="0 0 24 24"
                             stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
